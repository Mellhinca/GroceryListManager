...
public class HeirarchyAdapter extends BaseExpandableListAdapter {

    Context context;
    List<String> listGroup;
    HashMap<String,List<String>> listItem;

    public HeirarchyAdapter(Context context, List<String> listGroup, HashMap<String, List<String>> listItem){
